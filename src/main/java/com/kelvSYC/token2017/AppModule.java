...
public class AppModule {
    ...
    public SignatureKey signatureKey() {
         return new SignatureKey("Token Interview 2017 89c945fa-f83a-49da-a0c5-66dd50ec905e token-interview-2017 -1348243799488916455".getBytes(Charsets.UTF_8));
    }
    ...
    public ConfigSupplier appConfigSupplier(ConfigLoader configLoader) {
        // Load settings.properties in com.kelvSYC.token2017 package as a set of config entries
        return configLoader.fromResource("com/kelvSYC/token2017/settings");
    }
